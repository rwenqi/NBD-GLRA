function [mpsnr, mssim] = testpsnr_boundary(iter, testnum)

addpath(genpath('/home/vision/wren/caffe-dilate/'))
caffe.reset_all();

img_path = ('/home/vision/wren/data/deblur/GLR/test_pub/bsd100diskblur1.2noise1/');
...
for i = 1:testnum %length(hazy_data)
    ...
    blurimg = padarray(blurimg,[75 75],'replicate','both');
